...
impl App {
    pub fn draw_settings(&self, frame: &mut Frame, area: Rect) {
        let mut lines: Vec<Line> = vec![
            ...
            Line::from(vec![
                Span::raw("   "),
                Span::styled(
                    tr(self.lang, "settings_header_banner"),
                    Style::default()
                        .fg(Color::Black)
                        .bg(Color::Cyan)
        ...
        lines.push(Line::from(vec![
            ...
            Span::styled(
                format!("[ {} ]", self.model.to_uppercase()),
                Style::default()
                    .fg(Color::Black)
                    .bg(Color::White)
                    .add_modifier(Modifier::BOLD),
        ...
        lines.push(Line::from(vec![
            ...
            Span::styled(
                tr(self.lang, "settings_clear_action"),
                Style::default()
                    .fg(Color::White)
                    .bg(Color::LightRed)
                    .add_modifier(Modifier::BOLD),
    ...
    pub fn draw_input(&self, frame: &mut Frame, area: Rect) {
        let input_widget = if let Some(ref approval) = self.pending_approval {
            ...
            let alert_text = format_body.replacen("{}", &approval.tool_name, 1).replacen(
                "{}",
                &approval.arguments,
                1,
            );
